        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Controllers_Servers_ServerId",
                        column: x => x.ServerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NavigationId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Properties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Properties_Actions_ActionId",
                        column: x => x.ActionId,
                        principalTable: "Actions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Properties_Properties_NavigationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Controllers_ServerId",
                table: "Controllers",
                column: "ServerId");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_ActionId",
                table: "Properties",
                column: "ActionId");

            migrationBuilder.CreateIndex(
                name: "IX_Properties_NavigationId",
                table: "Properties",
                column: "NavigationId");
        }
